      ...
      <ScrollView>
        ...
        <TouchableOpacity onPress={pickImage}>
          <View
            style={[
              styles.button,
              { backgroundColor: config.primaryColor, borderRadius: 10 },
            ]}
          >
            <Text style={{ color: config.textColor, textAlign: "center" }}>
              Add Product
            </Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={handleCreateProduct}>
          ...
          >
            <Text
              style={{ color: config.backgroundColor, textAlign: "center" }}
            >
              Create
            </Text>
          </View>
        ...
        <TouchableOpacity onPress={reset}>
          ...
          >
            <Text
              style={{ color: config.textPrimaryColor, textAlign: "center" }}
            >
              Clear
            </Text>
          </View>
